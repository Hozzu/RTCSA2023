...
//pkshin start
	...
	u32 core_util_sum, memory_util_sum, core_util_fast_sum, memory_util_fast_sum;
	unsigned long core_util_avg, memory_util_avg, core_util_fast_avg, memory_util_fast_avg;
//pkshin end
