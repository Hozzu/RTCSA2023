...
#backgroud tab
driver.get(curPath + "Google.html")
time.sleep(5)
...
sites = ["Amazon.html", "Apple.html", "BBC.html", "Best Buy.html", "Britannica.html", "Cambridge.html", "craigslist.html", "Cricbuzz.html", "Dictionary.com.html", "Facebook.html", "Fandom.html", "IMDb.html", "Instagram.html", "LinkedIn.html", "Merriam-Webster.html"]
...
for index in range(len(sites)):
    ...
    response_time += wait_for_page_load(driver, curPath + sites[index], 20)
    time.sleep(5)
    driver.switch_to.window(driver.window_handles[-1])
